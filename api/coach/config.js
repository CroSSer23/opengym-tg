/* Coach instance configuration — the one place that knows whether this instance offers the
   ...
   cache, rather than LiftMate importing or duplicating an OAuth token. */
...
// This file is deliberately owned by LiftMate, not a person's normal Codex configuration. It
...
export function jobEnv(jobDir) {
  ...
  if (cfg.provider === 'codex') {
    ...
    // bind mount owned by `coach`; /data and every LiftMate secret remain inaccessible.
